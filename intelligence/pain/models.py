...
Migrated from backend/models/pain.py with added cluster_id field
on PainIssue for HDBSCAN label tracking.
"""
...
class PainIssue(BaseModel):
    ...
    url: str = ""
    cluster_id: int = -1              # HDBSCAN cluster label; -1 means noise/no cluster
